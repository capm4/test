            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center pagination-lg">
                    ...
                    for($countfirst = 1; $countfirst<=$data['count']; $countfirst++) {
                        ?>
                        <? if($countfirst == 1){?>
                            <li class="page-item"><a class="page-link" href="/sort/<? echo $data['sort']?>/"><? echo $countfirst?></a></li>
                        <? }else {?>
                            <li class="page-item"><a class="page-link" href="/sort/<? echo $data['sort']?>/<? echo ($countfirst+$countSecond)?>"><? echo $countfirst?></a></li>
                            <?
