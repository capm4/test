                 ...
                 <ul class="pagination justify-content-center pagination-lg">
                     <? $countSecond = 1;
                        for($countfirst = 1; $countfirst<=$data['count']; $countfirst++) {
                         ?>
                         <? if($countfirst == 1){?>
                             <li class="page-item"><a class="page-link" href="/"><? echo $countfirst?></a></li>
                         <? }else {?>
                          <li class="page-item"><a class="page-link" href="/<? echo ($countfirst+$countSecond)?>"><? echo $countfirst?></a></li>
                        <?
